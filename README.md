...
## Robot
Momentálně je jezdící robot nahrazen LED indikací. Tento kód zatím slouží pouze pro ověření funkčnosti komunikace pomocí Bluetooth.
...
![WheelControl](.fig/mecanum_wheels.png)